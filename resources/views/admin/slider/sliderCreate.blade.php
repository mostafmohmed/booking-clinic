      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{route('story')}}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="card-body">
                
               
                {{-- <div class="form-group">
                  <label for="exampleInputFile"><title></title> input</label>
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="text" name="title" class="custom-file-input" id="exampleInputFile">
                      <label class="custom-file-label" for="exampleInputFile">title</label>
                    </div>
                    @error('image')
                       <div class="alert alert-danger ">
{{$message}}
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1"><title></title></label>
